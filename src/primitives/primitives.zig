...
pub const PrecompileResult = @import("./src/precompile.zig").PrecompileResult;
pub const StandardPrecompileFn = @import("./src/precompile.zig").StandardPrecompileFn;
pub const EnvPrecompileFn = @import("./src/precompile.zig").EnvPrecompileFn;
